...
public class Puntos {
    ...
    public void crearPuntos(){
        System.out.println("Vamos a ingresar las coordenadas");
        int puntoA, puntoB;
        ...
        System.out.println("La coordenada del punto A es: " +x1+ "-"+y1);
        System.out.println("La coordenada del punto B es: " +x2+ "-"+y2);
    }
